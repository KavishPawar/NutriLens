        ...
        <main className="auth-page__main">
            ...
            <div className="auth-card">
                <div className="auth-card__header">
                    ...
                    <p className="auth-card__subtitle">Start your personalised nutrition journey today</p>
                </div>
                ...
                <form className="auth-card__form" onSubmit={handleSubmit}>
                    <div className="auth-card__field">
                        <label className="auth-card__label" htmlFor="register-username">Username</label>
                        <input
                    ...
                    <div className="auth-card__field">
                        <label className="auth-card__label" htmlFor="register-email">Email address</label>
                        <input
                            id="register-email"
                            className="auth-card__input"
                            type='email'
                    ...
                    <div className="auth-card__field">
                        <label className="auth-card__label" htmlFor="register-password">Password</label>
                        <input
                    ...
                    <button id="register-submit-btn" className="auth-card__submit" type="submit">
                        Create account
